...
class DiffusionUNet(nn.Module):
    def __init__(self, config):
        ...
        in_channels = config.model.in_channels + config.model.out_ch if config.data.conditional else config.model.in_channels
    ...
    def forward(self, x, t):
        ...
        # print(x.shape[2],x.shape[3],self.resolution)
